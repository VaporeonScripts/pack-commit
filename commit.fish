...
echo ""
echo "========================================="
echo "   $PACK_NAME â€” GitHub Commit Script"
...
if test $dry_run -eq 1
    echo "   [DRY RUN â€” nothing will be committed or pushed]"
end
echo "========================================="
echo ""
set_color normal
...
if test "$push_confirm" = "n"; or test "$push_confirm" = "N"
    echo "Push skipped. Your commits are saved locally â€” next time you run this"
